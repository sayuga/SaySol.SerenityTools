...
| 9.2.x | Final .NET 8 line | Historical upgrade context only | Do not claim support or maintain a validation lane |
...
Repository support begins at Serenity 10.5. Earlier entries remain only to
explain why legacy wiki material may require redesign.
